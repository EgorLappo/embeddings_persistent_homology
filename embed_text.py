...
if __name__ == "__main__":
    ...
    #GLoVe
    glove2word2vec(glove_input_file="data/glove.6B.300d.txt", word2vec_output_file="data/glove.6B.300d.gensim.txt")
    glove2word2vec(glove_input_file="data/glove.840B.300d.txt", word2vec_output_file="glove.840B.300d.gensim.txt")
    glove_cc_model = gensim.models.KeyedVectors.load_word2vec_format('data/glove.840B.300d.gensim.txt', binary=False)
    glove_wiki_model = gensim.models.KeyedVectors.load_word2vec_format('data/glove.6B.300d.gensim.txt', binary=False)
