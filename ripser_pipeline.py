...
if __name__ == "__main__":
    ...
    # prepare for Plex
    vectors_to_plex(word2vec_embeddings, filename="plex_input/"+text_filename+".word2vec_plex")
    vectors_to_plex(glove_cc_embeddings, filename="plex_input/"+text_filename+".glove_cc_plex")
